  ...
  return (
    ...
    <>
      ...
      <AlertDialog>
        ...
        <AlertDialogContent className="max-w-[90vw] w-[900px] max-h-[90vh] h-[700px]">
          <AlertDialogHeader>
            <AlertDialogTitle className="flex justify-center">
              <form onSubmit={updateTitle} className="flex w-full max-w-6xl mx-auto justify-between pb-5">
                <Input
                  className="flex flex-1 space-x-2"
                  value={temp_title}
                  onChange={(e) => setTitle(e.target.value)}
                />
                <Button disabled={isUpdating} type="submit" className="ml-4">
                  {isUpdating ? "Updating..." : "Update"}
                </Button>
              </form>
            </AlertDialogTitle>
            <AlertDialogDescription className="p-3 flex-grow overflow-y-auto">
              <TaskAlert id={id} />
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
